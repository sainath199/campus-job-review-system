...
|Docs: what: point descriptions of each class/function (in isolation)|3|[GitHub Link(https://github.com/akshat22/campus-job-review-system/pulse)|
|Use of style checkers|3|Using [Pycodestyle](https://pypi.org/project/pep8/)|
|Use of code formatters|3|Using [Black](https://black.readthedocs.io/en/stable/)|
...
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)|3|Multiple people working on files across the project|
